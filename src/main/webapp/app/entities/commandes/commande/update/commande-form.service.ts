...
type CommandeFormGroupContent = {
  ...
  referentiel: FormControl<CommandeFormRawValue['referentiel']>;
  userId: FormControl<CommandeFormRawValue['userId']>;
...
export class CommandeFormService {
  createCommandeFormGroup(commande: CommandeFormGroupInput = { id: null }): CommandeFormGroup {
    ...
    return new FormGroup<CommandeFormGroupContent>({
      ...
      referentiel: new FormControl(commandeRawValue.referentiel, {
        validators: [Validators.required],
      }),
      userId: new FormControl(commandeRawValue.userId, {
        validators: [Validators.required],
      }),
