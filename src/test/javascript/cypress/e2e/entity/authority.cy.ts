...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '00160d6b-ea9e-4120-bc4c-dcf8a1467e48' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('13cd7ba7-966a-4cad-a4ea-156d2221a996');
      cy.get(`[data-cy="name"]`).should('have.value', '13cd7ba7-966a-4cad-a4ea-156d2221a996');
